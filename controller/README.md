...
The most popular circuit to operate a 3 phase motor is a 3 half-bridge system. each half bridge consists of 2 MOSFETs - high side connected to V+ and low side to GND. The source side of both MOSFETs is connected and forms a bridge. This way, by switching each side on and off, we can controll the voltage on the bridge using PWM.
